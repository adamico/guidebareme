...
var tarteaucitron = {
        ...
        tarteaucitron.addScript(pathToLang, '', function () {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                html += '            </button> ';
                html += '            <button type="button" id="tarteaucitronAllDenied" class="tarteaucitronDeny" onclick="tarteaucitron.userInterface.respondAll(false); setOptout();">';
    ...
    "addService": function (serviceId) {
        ...
        if (tarteaucitron.added[service.key] !== true) {
            ...
            if (tarteaucitron.parameters.moreInfoLink == true) {
                ...
                html += '       </a>';*/
            	var titleDesc = service.name.replace("<span class='tacTitleDesc'>","").replace("</span>", "");
                html += '        - ';
                html += '       <a href="' + service.uri + '" target="_blank" rel="noreferrer noopener" title="' + titleDesc + ' ' + tarteaucitron.lang.newWindow + '">';
    ...
    "cookie": {
        ...
        "create": function (key, status) {
            ...
            document.cookie = value + '; expires=' + d.toGMTString() + '; path=/;' + domain+";secure";
        },
        "read": function () {
            "use strict";
        ...
        "purge": function (arr) {
            ...
            for (i = 0; i < arr.length; i += 1) {
            	// [ALM-522] Checkmarx
            	var domaineHostname = encodeURI(location.hostname);
                document.cookie = arr[i] + '=; expires=Thu, 01 Jan 2000 00:00:00 GMT; path=/;';
                document.cookie = arr[i] + '=; expires=Thu, 01 Jan 2000 00:00:00 GMT; path=/; domain=.' +  decodeURI(domaineHostname) + ';';
                document.cookie = arr[i] + '=; expires=Thu, 01 Jan 2000 00:00:00 GMT; path=/; domain=.' +  decodeURI(domaineHostname).split('.').slice(-2).join('.') + ';';
            }
        },
        ...
        "number": function () {
            ...
            var cookies = getAllCookiesOfDocument().split(';'),
...
function getAllCookiesOfDocument(){
	var cook = "";
	try {
		cook = encodeURI(document.cookie);
	} catch (e) {
	}
...
tarteaucitron.init({
	  ...
	  "readmoreLink": "/contenu/pied-de-page/mentions-legales" /* Change the default readmore link */
  });